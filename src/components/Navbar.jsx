...
function Navbar() {
  ...
  return (
    <>
      <div className="max-w-screen-2xl container mx-auto px-4 md:px-20 h-16 shadow-md fixed top-0 left-0 right-0 z-50 bg-gray-950 text-gray-900">
        <div className="flex justify-between items-center h-16">
          ...
          <div>
            ...
            <div onClick={() => setMenu(!menu)} className="md:hidden text-orange-500">
